    ...
    return (
      <Grid style={landingStyle} id='landing-page' container centered>
        <Grid.Column width={11}>
          ...
          <p className="mission-text">Q) How can I use this site?</p>
          <p className="mission-text">- A) Please fill out your profile after signing up.</p>
          <p className="mission-text">Q) I want to sell clothes, what should I do?</p>
          ...
          <p className="mission-text">- A) You can find clothes in the category you want to purchase. You can also use the search bar.</p>
